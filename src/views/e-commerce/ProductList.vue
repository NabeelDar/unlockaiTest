  ...
  <div class="card">
    ...
    <div class="grid -mt-3 -ml-3 -mr-3">
      <div v-for="(product, i) in products" :key="i" class="col-12 md:col-6 lg:col-4">
        <div class="p-2">
          <div class="border-1 surface-border p-4 surface-card border-round">
            <div class="relative mb-3">
              <span class="surface-card text-900 shadow-2 px-3 py-2 absolute"
                    style="border-radius: 1.5rem; left: 1rem; top: 1rem"> Category </span>
              <img :alt="i" :src="product.image" class="w-full"/>
            </div>
