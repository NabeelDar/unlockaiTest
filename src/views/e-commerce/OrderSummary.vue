...
<template>
  <div class="card px-4 py-8 md:px-6 lg:px-8">
    ...
    <p class="text-700 text-xl mt-0 mb-4 p-0">Your order is on the way. It&lsquo;ll be shipped today. We&lsquo;ll inform
      you.</p>
    <div
    ...
    <div class="flex flex-column sm:flex-row sm:align-items-center sm:justify-content-between py-5">
      ...
      <div>
        <Button class="mr-2" icon="pi pi-list" label="Details" outlined></Button>
        <Button icon="pi pi-print" label="Print" outlined></Button>
      </div>
    </div>
    <div class="border-round surface-border border-1">
      <ul class="list-none p-0 m-0">
        <li v-for="(product, i) in products" :key="i"
          ...
          <img :alt="product.name" :src="product.image" class="w-3rem sm:w-8rem flex-shrink-0 mr-3 shadow-2"/>
    ...
    <div class="flex flex-wrap mt-5 pb-3">
      <div class="w-full lg:w-6 pl-3">
        ...
        <div class="flex align-items-center mt-3">
          <img alt="visa" class="w-4rem mr-3" src="/demo/images/ecommerce/ordersummary/visa.png"/>
          <div class="flex flex-column">
  ...
  <div class="card px-4 py-8 md:px-6 lg:px-8 mt-6">
    ...
    <div class="flex flex-column md:flex-row md:align-items-center border-bottom-1 surface-border py-5">
      <img alt="summary-1-2" class="w-15rem flex-shrink-0 md:mr-6"
      ...
      <div class="flex-auto mt-3 md:mt-0">
        ...
        <div :style="{ height: '7px' }" class="border-round overflow-hidden surface-300 mb-3">
    ...
    <div class="py-5 flex justify-content-between flex-wrap">
      ...
      <div class="flex flex-column">
        ...
        <div class="flex align-items-center mt-3">
          <img alt="visa-2" class="w-4rem mr-3" src="/demo/images/ecommerce/ordersummary/visa.png"/>
          <div class="flex flex-column">
            <span class="text-900 mb-1">Visa Debit Card</span>
            <span class="text-900 font-medium">**** **** **** 1234</span>
          </div>
