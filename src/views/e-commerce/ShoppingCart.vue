  ...
  <div class="card px-4 py-8 md:px-6 lg:px-8">
    ...
    <ul class="list-none p-0 m-0">
      <li class="flex flex-column md:flex-row py-6 border-top-1 border-bottom-1 surface-border md:align-items-center">
        <img alt="shopping-cart-2-1"
             class="w-12rem flex-shrink-0 mx-auto md:mx-0" src="/demo/images/ecommerce/shopping-cart/shopping-cart-2-1.png"/>
        <div class="flex-auto py-5 md:pl-5">
          <div
            ...
            <div class="w-full sm:w-6 flex align-items-start justify-content-between mt-3 sm:mt-0">
              <div>
                <Dropdown v-model="selectedQuantity" :options="quantityOptions" optionLabel="label"></Dropdown>
              </div>
      ...
      <li class="flex flex-column md:flex-row py-6 border-top-1 border-bottom-1 surface-border md:align-items-center">
        <img alt="shopping-cart-2-2"
             class="w-12rem flex-shrink-0 mx-auto md:mx-0" src="/demo/images/ecommerce/shopping-cart/shopping-cart-2-2.png"/>
        <div class="flex-auto py-5 md:pl-5">
          <div
              class="flex flex-wrap align-items-start sm:align-items-center sm:flex-row sm:justify-content-between surface-border pb-6">
            <div class="w-full sm:w-6 flex flex-column">
            ...
            <div class="w-full sm:w-6 flex align-items-start justify-content-between mt-3 sm:mt-0">
              <div>
                <Dropdown v-model="selectedQuantity2" :options="quantityOptions" optionLabel="label"></Dropdown>
              </div>
              <div class="flex flex-column sm:align-items-end">
