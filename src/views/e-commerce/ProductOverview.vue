  ...
  <div class="card">
    <div class="grid mb-7">
      <div class="col-12 lg:col-7">
        <div class="flex">
          <div :style="{ rowGap: '1rem' }" class="flex flex-column w-2 justify-content-between">
            <img
      ...
      <div class="col-12 lg:col-4 py-3 lg:pl-6">
        ...
        <div class="mb-3 flex align-items-center justify-content-between">
          ...
          <a class="cursor-pointer text-600 text-sm flex align-items-center" tabindex="0"> Size Guide <i
        ...
        <div class="flex flex-column sm:flex-row sm:align-items-center sm:justify-content-between">
          ...
          <div class="flex align-items-center flex-1 mt-3 sm:mt-0 ml-0 sm:ml-5">
            <Button class="flex-1 mr-5" label="Add to Cart"></Button>
            <i :class="{ 'pi-heart text-600': !liked, 'pi-heart-fill text-orange-500': liked }"
    ...
    <TabView>
      <TabPanel header="Details">
        ...
        <p class="line-height-3 text-600 p-0 mx-0 mt-0 mb-4">
          ...
          tincidunt id. Sed tempus urna et pharetra. Metus vulputate eu scelerisque felis imperdiet proin fermentum.
          Venenatis urna
          cursus eget nunc scelerisque viverra mauris in. Viverra justo nec ultrices dui sapien eget mi proin. Laoreet
        ...
        <ul class="list-none p-0 m-0">
          <li class="pb-5 border-bottom-1 surface-border">
            ...
            <p class="mx-0 mt-0 mb-3 text-600 line-height-3">
              Blandit libero volutpat sed cras ornare arcu dui vivamus. Arcu dictum varius duis at consectetur lorem
              donec massa. Imperdiet proin fermentum leo vel orci porta non. Porttitor rhoncus dolor purus non.
            </p>
          ...
          <li class="py-5 border-bottom-1 surface-border">
            ...
            <p class="mx-0 mt-0 mb-3 text-600 line-height-3">Venenatis cras sed felis eget. Proin nibh nisl condimentum
              id venenatis a condimentum.</p>
      ...
      <TabPanel header="Shipping and Returns">
        ...
        <p class="line-height-3 text-600 p-0 mx-0 mt-0 mb-4">
          Mattis aliquam faucibus purus in massa tempor nec feugiat nisl. Justo donec enim diam vulputate ut pharetra.
          Tempus egestas sed sed risus. Feugiat sed lectus vestibulum mattis. Tristique nulla aliquet enim tortor at
          auctor urna
        ...
        <div class="grid">
          ...
          <div class="col-12 md:col-6">
            ...
            <p class="line-height-3 text-600 p-0 m-0">Pharetra et ultrices neque ornare aenean euismod elementum nisi.
              Diam phasellus vestibulum lorem sed. Mattis molestie a iaculis at.</p>
          </div>
        </div>
      </TabPanel>
    </TabView>
