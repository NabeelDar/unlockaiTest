...
<template>
  <div class="grid">
    <div class="col-12">
      <div class="card">
        <h5>DataView</h5>
        <DataView :layout="layout" :paginator="true" :rows="9" :sortField="sortField"
                  :sortOrder="sortOrder" :value="filteredValue || dataviewValue">
          <template #header>
            <div class="flex flex-column md:flex-row md:justify-content-between gap-2">
              ...
              <span class="p-input-icon-left">
                                ...
                                <InputText v-model="globalFilterValue" placeholder="Search by Name" @input="onFilter"/>
                            </span>
              <div>
          ...
          <template #list="slotProps">
            <div class="col-12">
              <div class="flex flex-column md:flex-row align-items-center p-3 w-full">
                <img :alt="slotProps.data.name" :src="'/demo/images/product/' + slotProps.data.image"
                ...
                <div
                  ...
                  <Button :disabled="slotProps.data.inventoryStatus === 'OUTOFSTOCK'" class="mb-2"
            ...
            <div class="col-12 md:col-4">
              <div class="card m-3 border-1 surface-border">
                ...
                <div class="flex align-items-center justify-content-between">
                  ...
                  <Button :disabled="slotProps.data.inventoryStatus === 'OUTOFSTOCK'"
