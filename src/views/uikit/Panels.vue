      ...
      <div class="card">
        ...
        <Toolbar>
          <template v-slot:start>
            ...
            <Button class="mr-2" icon="pi pi-folder-open" label="Open" severity="secondary"/>

            <i class="pi pi-bars p-toolbar-separator mr-2"></i>

            <Button class="mr-2" icon="pi pi-check" severity="success"/>
            <Button class="mr-2" icon="pi pi-trash" severity="warning"/>
      ...
      <div class="card">
        ...
        <div class="grid">
          ...
          <div class="col-5 align-items-center justify-content-center">
            ...
            <Divider align="right">
              <Button icon="pi pi-search" label="Button" outlined></Button>
            </Divider>
