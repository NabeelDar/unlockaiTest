  ...
  <div class="grid">
    ...
    <div class="col-12 lg:col-6">
      <div class="card">
        ...
        <Button badge="8" badgeClass="p-badge-danger" icon="pi pi-users" label="Messages" severity="warning"></Button>
      ...
      <div class="card">
        ...
        <AvatarGroup class="mb-3">
          ...
          <Avatar :style="{ 'background-color': '#9c27b0' }" class="text-white" label="+2" shape="circle"
                  size="large"></Avatar>
        </AvatarGroup>

        <h5>Label - Circle</h5>
        <Avatar class="mr-2" label="P" shape="circle" size="xlarge"></Avatar>
        <Avatar :style="{ 'background-color': '#2196F3' }" class="mr-2 text-white" label="V" shape="circle"
                size="large"></Avatar>
        <Avatar :style="{ 'background-color': '#9c27b0' }" class="mr-2 text-white" label="U" shape="circle"></Avatar>
      ...
      <div class="card">
        ...
        <ScrollPanel :style="{ width: '250px', height: '200px' }">
          <p>
            ...
            consectetur
            adipiscing elit ut. Nam libero justo laoreet sit amet. Pharetra massa massa ultricies mi quis hendrerit
            dolor magna. Est ultricies integer quis auctor elit sed vulputate. Consequat ac felis donec et. Tellus orci
            ac auctor
            augue mauris. Semper feugiat nibh sed pulvinar proin gravida hendrerit lectus a. Tincidunt arcu non sodales
            neque sodales. Metus aliquam eleifend mi in nulla posuere sollicitudin aliquam ultrices. Sodales ut etiam
            sit amet
            nisl purus. Cursus sit amet dictum sit amet. Tristique senectus et netus et malesuada fames ac turpis
            egestas. Et tortor consequat id porta nibh venenatis cras sed. Diam maecenas ultricies mi eget mauris. Eget
            egestas purus
