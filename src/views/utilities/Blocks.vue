...
<template>
  <div>
    <BlockViewer :code="block1" free header="Hero">
      <div class="grid grid-nogutter surface-section text-800">
        <div class="col-12 md:col-6 p-6 text-center md:text-left flex align-items-center">
          <section>
            <span class="block text-6xl font-bold mb-1">Create the screens </span>
            ...
            <Button class="mr-3" label="Learn More" raised type="button"></Button>
            <Button label="Live Demo" outlined type="button"></Button>
          </section>
        </div>
        <div class="col-12 md:col-6 overflow-hidden">
          <img alt="Image" class="md:ml-auto block md:h-full" src="/demo/images/blocks/hero/hero-1.png"
               style="clip-path: polygon(8% 0, 100% 0%, 100% 100%, 0 100%)"/>
        </div>
      </div>
    </BlockViewer>

    <BlockViewer :code="block2" free header="Feature">
      <div class="surface-section px-4 py-8 md:px-6 lg:px-8 text-center">
        <div class="mb-3 font-bold text-3xl">
          <span class="text-900">One Product, </span>
          <span class="text-blue-600">Many Solutions</span>
    ...
    <BlockViewer :code="block3" free header="Pricing">
      <div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
        <div class="text-900 font-bold text-6xl mb-4 text-center">Pricing Plans</div>
          ...
          <div class="col-12 lg:col-4">
            <div class="p-3 h-full">
              <div class="shadow-2 p-3 flex flex-column surface-card" style="border-radius: 6px">
                ...
                <hr class="mb-3 mx-0 border-top-1 border-none surface-border"/>
                <Button class="p-3 w-full" label="Buy Now" outlined></Button>
              </div>
            </div>
          </div>
        </div>
    ...
    <BlockViewer :code="block4" free header="Call to Action">
      <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
        <div class="text-700 text-center">
          <div class="text-blue-600 font-bold mb-3"><i class="pi pi-discord"></i>&nbsp;POWERED BY DISCORD</div>
          <div class="text-900 font-bold text-5xl mb-3">Join Our Design Community</div>
          ...
          <Button class="font-bold px-5 py-3 white-space-nowrap" icon="pi pi-discord" label="Join Now" raised
                  rounded></Button>
        </div>
      </div>
    </BlockViewer>

    <BlockViewer :code="block5" containerClass="surface-section py-8" free header="Banner">
      <div
        ...
        <a v-ripple
           class="p-ripple flex align-items-center no-underline justify-content-center border-circle text-gray-50 hover:bg-bluegray-700 cursor-pointer transition-colors transition-duration-150"
    ...
    <BlockViewer :code="block6" free header="Page Heading">
      <div class="surface-section px-4 py-5 md:px-6 lg:px-8">
        <ul class="list-none p-0 m-0 flex align-items-center font-medium mb-3">
          <li>
            <a class="text-500 no-underline line-height-3 cursor-pointer">Application</a>
        ...
        <div class="flex align-items-start flex-column lg:justify-content-between lg:flex-row">
          ...
          <div class="mt-3 lg:mt-0">
            <Button class="mr-2" icon="pi pi-user-plus" label="Add" outlined></Button>
    ...
    <BlockViewer :code="block7" free header="Stats">
      <div class="surface-ground px-4 py-5 md:px-6 lg:px-8">
        <div class="grid">
          <div class="col-12 md:col-6 lg:col-3">
            <div class="surface-card shadow-2 p-3 border-round">
    ...
    <BlockViewer :code="block8" containerClass="surface-ground px-4 py-8 md:px-6 lg:px-8 flex align-items-center justify-content-center"
                 free
                 header="Sign-In">
      <div class="surface-card p-4 shadow-2 border-round w-full lg:w-6">
        <div class="text-center mb-5">
        ...
        <div>
          ...
          <InputText id="email1" class="w-full mb-3" placeholder="Email address" type="text"/>

          <label class="block text-900 font-medium mb-2" for="password1">Password</label>
          <InputText id="password1" class="w-full mb-3" placeholder="Password" type="password"/>

          <div class="flex align-items-center justify-content-between mb-6">
            <div class="flex align-items-center">
              <Checkbox id="rememberme1" v-model="checked" :binary="true" class="mr-2"></Checkbox>
              <label class="text-900" for="rememberme1">Remember me</label>
            </div>
            <a class="font-medium no-underline ml-2 text-blue-500 text-right cursor-pointer">Forgot password?</a>
          </div>
    ...
    <BlockViewer :code="block9" containerClass="surface-section px-4 py-8 md:px-6 lg:px-8" free
      ...
      <div class="surface-section">
        ...
        <ul class="list-none p-0 m-0">
          <li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
            ...
            <div class="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">Heat</div>
            <div class="w-6 md:w-2 flex justify-content-end">
              <Button icon="pi pi-pencil" label="Edit" text></Button>
            </div>
          </li>
          <li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
            <div class="text-500 w-6 md:w-2 font-medium">Genre</div>
          ...
          <li class="flex align-items-center py-3 px-2 border-top-1 border-bottom-1 surface-border flex-wrap">
            <div class="text-500 w-6 md:w-2 font-medium">Plot</div>
            <div class="text-900 w-full md:w-8 md:flex-order-0 flex-order-1 line-height-3">A group of professional bank
              robbers start to feel the heat from police when they unknowingly leave a clue at their latest heist.
            </div>
            <div class="w-6 md:w-2 flex justify-content-end">
              <Button icon="pi pi-pencil" label="Edit" text></Button>
            </div>
    ...
    <BlockViewer :code="block10" containerClass="px-4 py-8 md:px-6 lg:px-8" free header="Card">
      <div class="surface-card p-4 shadow-2 border-round">
        <div class="text-3xl font-medium text-900 mb-3">Card Title</div>
        <div class="font-medium text-500 mb-3">Vivamus id nisl interdum, blandit augue sit amet, eleifend mi.</div>
