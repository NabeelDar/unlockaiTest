  ...
  <div class="grid">
    <div class="col-12">
      ...
      <div class="grid p-2" style="margin: -1rem">
        ...
        <div class="col-12 sm:col p-3">
          <div class="card text-white flex justify-content-between pt-4 h-full"
               style="background: linear-gradient(90deg, #ffb340 0%, #ffa740 100%); min-width: 17rem">
            <div class="overview-info">
    ...
    <div class="col-12 xl:col-8 p-3">
      <div class="card">
        ...
        <Chart :data="chartData" :height="520" :options="chartOptions" type="bar"></Chart>
      </div>
    </div>
        ...
        <div class="col-12 md:col-6 xl:col-12">
          <div class="card">
            ...
            <TabView class="w-full p-0">
                ...
                <ul class="list-none p-0 overflow-auto" style="margin: 0 -1.5rem -1rem; max-height: 17.745rem">
                  <li class="border-round-lg pt-2 px-3 pb-2 mb-3"
                    ...
                    <div class="flex justify-content-between align-items-center">
                      ...
                      <Button class="flex-shrink-0" icon="pi pi-ellipsis-v" rounded size="small" text type="button"
              ...
              <TabPanel>
                <template #header>
                  <div v-badge.warning="3" class="pr-2">
                ...
                <ul class="list-none p-0 overflow-auto" style="margin: 0 -1.5rem -1rem; max-height: 17.745rem">
                  <li class="border-round-lg pt-2 px-3 pb-2 mb-3"
                    ...
                    <div class="flex justify-content-between align-items-center">
                                            <span
                                                class="mt-1 text-400 block text-sm line-height-1 white-space-nowrap overflow-hidden text-overflow-ellipsis">
                      ...
                      <Button class="flex-shrink-0" icon="pi pi-ellipsis-v" rounded size="small" text type="button"
                              @click="menu2.toggle($event)"></Button>
                    </div>
                  </li>
                  <li class="border-round-lg pt-2 px-3 pb-2 mb-3"
                      style="background-color: var(--primary-lighter-color)">
          ...
          <div class="card mt-2">
            ...
            <div class="flex align-items-center justify-content-between">
              <ul class="list-none p-0 m-0">
                <li class="mb-3 flex align-items-center"><i class="pi pi-circle-fill text-primary-300 mr-2"></i><span>Watches</span>
                </li>
                <li class="mb-3 flex align-items-center"><i class="pi pi-circle-fill text-orange-300 mr-2"></i><span>Clothing</span>
                </li>
                <li class="mb-3 flex align-items-center"><i class="pi pi-circle-fill text-green-300 mr-2"></i><span>Gadgets</span>
                </li>
                <li class="mb-3 flex align-items-center"><i class="pi pi-circle-fill text-cyan-300 mr-2"></i><span>Accessories</span>
                </li>
              </ul>
              <Chart :data="pieData" :height="140" :options="pieOptions" :width="140" type="doughnut"></Chart>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-12 xl:col-3 p-3">
      <div class="card overflow-auto">
        ...
        <Chart :data="chart1" :options="chartOptions1" :responsive="true" style="max-height: 160px" type="line"></Chart>
        <div class="p-3 border-round-xl my-3 mx-0" style="background-color: var(--primary-lighter-color)">
          <div class="flex align-items-center b-2">
            <img alt="freya-layout" src="/demo/images/dashboard/subtract.svg"/>
        ...
        <Button class="w-full" label="Go to Clients Reports" outlined type="button"></Button>
      </div>
    </div>
      ...
      <div class="card h-full">
        <div class="card-header gap-3">
          ...
          <div class="inline-flex align-items-center">
            ...
            <Button class="mx-3" icon="pi pi-upload" rounded @click="dt.exportCSV()"></Button>
          </div>
        </div>
        <DataTable v-model:expandedRows="expandedRows" v-model:filters="filterSalesTable" :paginator="true" :rows="3"
                   :tableStyle="{ minWidth: '60rem' }" :value="activeAds">
          <Column expander style="width: 3rem"/>
          <Column :sortable="true" class="px-1" field="name" header="Name" style="width: 50%"/>
          <Column header="">
            <template #body="slotProps">
              <img :alt="slotProps.data.name" :src="slotProps.data.image" class="border-round" height="60"/>
            </template>
          </Column>
          <Column :sortable="true" field="adROI" header="Ad ROI" headerClass="px-1 py-2 text-right "/>
          <Column :sortable="true" field="adCTR" header="Ad CTR" headerClass="px-1 py-2 text-right"/>
          <template #expansion="slotProps">
            <div class="flex">
              <img :alt="slotProps?.data?.name" :src="slotProps?.data?.image" class="border-round" height="160"/>
              <div class="ml-3 w-8">
                <div class="p-3">
