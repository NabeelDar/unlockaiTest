  ...
  <div>
    <div class="card">
      <div
        ...
        <svg class="absolute w-full top-0 left-0" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <span class="p-input-icon-left w-9 md:w-6">
                    ...
                    <InputText id="name" :style="{ borderRadius: '2rem' }" class="w-full" placeholder="Search"
                               type="text"/>
                </span>
      </div>
