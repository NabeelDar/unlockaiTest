    ...
    <Timeline :value="customEvents" align="alternate" class="customized-timeline">
      ...
      <template #content="slotProps">
        <Card>
          ...
          <template #content>
            <img v-if="slotProps.item.image" :alt="slotProps.item.name"
                 :src="'/demo/images/product/' + slotProps.item.image" class="shadow-2" width="200"/>
            <p>
            ...
            <Button class="mb-5" label="Read more" outlined></Button>
          </template>
        </Card>
      </template>
    </Timeline>
