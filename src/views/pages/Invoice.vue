  ...
  <div class="card py-8 px-6 md:px-8 overflow-auto">
    <div
      ...
      <div class="flex flex-column">
        <svg fill="none" height="50" viewBox="0 0 48 50" width="48" xmlns="http://www.w3.org/2000/svg">
          <path
              clipRule="evenodd"
    ...
    <div class="overflow-x-auto">
      <table :style="{ borderCollapse: 'collapse', tableLayout: 'auto' }" class="w-full">
        <thead>
        <tr>
          ...
          <th class="text-right font-semibold py-3 border-bottom-1 surface-border white-space-nowrap px-3">Unit Price
          </th>
