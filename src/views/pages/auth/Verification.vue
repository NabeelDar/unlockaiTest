  ...
  <div class="surface-0">
    <div class="flex align-items-center justify-content-between flex-column h-screen">
      <div
        ...
        <a class="mb-6" style="cursor: pointer" @click="navigateToDashboard">
          <svg fill="none" height="56" viewBox="0 0 17 20" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M0 0H6.00019V3.82345L17 1.66667V6.66667L6.00019 8.82345V10.4901L17 8.33333V13.3333L6.00019 15.4901V20H0V0Z"
                fill="url(#paint0_linear)"/>
            <defs>
              <linearGradient id="paint0_linear" gradientUnits="userSpaceOnUse" x1="3.33335" x2="8.49995" y1="3.08442e-08"
                              y2="20">
        ...
        <div class="flex flex-column">
          <div class="flex justify-content-between w-full align-items-center mb-4 gap-3">
            <InputText v-model="val1" class="w-3rem text-center text-color-secondary surface-50 border-200"
                       maxlength="1" @keyup="onDigitInput($event)"/>
            <InputText v-model="val2" class="w-3rem text-center text-color-secondary surface-50 border-200"
                       maxlength="1" @keyup="onDigitInput($event)"/>
            <InputText v-model="val3" class="w-3rem text-center text-color-secondary surface-50 border-200"
                       maxlength="1" @keyup="onDigitInput($event)"/>
            <InputText v-model="val4" class="w-3rem text-center text-color-secondary surface-50 border-200"
                       maxlength="1" @keyup="onDigitInput($event)"/>
          </div>

          <div class="flex flex-wrap gap-2 justify-content-between">
            <Button class="flex-auto" label="Cancel" outlined @click="navigateToDashboard"></Button>
            <Button class="flex-auto" label="Verify" @click="navigateToDashboard"></Button>
          </div>
        </div>
      </div>
