  ...
  <div class="surface-0">
    <div class="flex align-items-center justify-content-between flex-column h-screen">
      <div
        ...
        <a style="cursor: pointer" @click="navigateToDashboard">
        ...
        <div class="mb-4 w-full md:w-25rem flex gap-4 align-items-center justify-content-between">
          <div class="text-center flex align-items-center">
            <img alt="Avatar" class="w-3rem h-3rem mb-2" src="/demo/images/avatar/amyelsner.png"/>
        ...
        <div class="flex flex-column w-full md:w-25rem">
                    <span class="p-input-icon-left w-full mb-4">
                        ...
                        <InputText id="password" class="w-full md:w-25rem text-color-secondary surface-50 border-200"
                                   placeholder="Password"
                                   type="password"/>
                    </span>
          <Button class="w-full" label="Unlock" @click="navigateToDashboard"></Button>
