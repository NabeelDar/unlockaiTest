      ...
      <div
        ...
        <div class="flex flex-column">
                    <span class="p-input-icon-left w-full mb-4">
                        ...
                        <InputText id="username" class="w-full md:w-25rem text-color-secondary surface-50 border-200"
                                   placeholder="Username"
                                   type="text"/>
                    </span>
          <span class="p-input-icon-left w-full mb-4">
                        <i class="pi pi-envelope"></i>
                        <InputText id="email" class="w-full md:w-25rem text-color-secondary surface-50 border-200"
                                   placeholder="Email"
                                   type="text"/>
                    </span>
          <span class="p-input-icon-left w-full mb-4">
                        <i class="pi pi-lock z-2"></i>
                        <Password id="password" v-model="value" :inputStyle="{ paddingLeft: '2.5rem' }" class="w-full"
          ...
          <div class="mb-4 flex flex-wrap align-items-center">
            <Checkbox v-model="confirmed" :binary="true" class="mr-2" name="checkbox" value="val"></Checkbox>
            <label class="text-900 font-medium mr-2" for="checkbox"> I have read the</label>
            <a class="text-600 cursor-pointer hover:text-primary cursor-pointer">Terms and Conditions</a>
          </div>
          <Button class="w-full mb-4" label="Sign Up" @click="navigateToDashboard"></Button>
