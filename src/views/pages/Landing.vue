...
const activeImage = ref('/demo/images/landing/chat.png');
const images = [
  {name: 'chat', src: '/demo/images/landing/chat.png'},
  {name: 'mail', src: '/demo/images/landing/mail.png'},
  {name: 'task-list', src: '/demo/images/landing/task-list.png'},
  {name: 'blog', src: '/demo/images/landing/blog.png'}
];
...
<template>
  <div
      :class="(menu?.classList.contains('hidden') && menu?.classList.contains('absolute') ? 'h-auto ' : 'overflow-hidden h-screen  md:h-auto ') + 'landing-wrapper'">
    <div
        :class="(menu?.classList.contains('hidden') && menu?.classList.contains('absolute') ? 'hidden ' : 'block md:hidden ') + ' absolute z-4 top-0 right-0 w-full h-screen'"
        style="background-color: var(--maskbg)"></div>
    <div class="flex align-items-center justify-content-between relative lg:static py-6 mx-0 px-4 lg:py-6">
      <a class="cursor-pointer" @click="navigateHome">
        <svg fill="none" height="32" viewBox="0 0 66 19" xmlns="http://www.w3.org/2000/svg">
          <path
          ...
          />
          <defs>
            <linearGradient id="paint0_linear_7_2" gradientUnits="userSpaceOnUse" x1="4.02237" x2="8.24281" y1="9.46943e-08"
                            y2="16.4905">
              <stop stop-color="var(--primary-400)"/>
              <stop offset="1" stop-color="var(--primary-700)"/>
            </linearGradient>
            <linearGradient id="paint1_linear_7_2" gradientUnits="userSpaceOnUse" x1="25.0035" x2="18.0327" y1="0.213131"
                            y2="13.0728">
              <stop stop-color="var(--primary-400)"/>
              <stop offset="1" stop-color="var(--primary-700)"/>
            </linearGradient>
            <linearGradient id="paint2_linear_7_2" gradientUnits="userSpaceOnUse" x1="30.3648" x2="23.1051" y1="0.168197"
                            y2="13.5662">
              <stop stop-color="var(--primary-400)"/>
              <stop offset="1" stop-color="var(--primary-700)"/>
            </linearGradient>
            <linearGradient id="paint3_linear_7_2" gradientUnits="userSpaceOnUse" x1="29.6161" x2="21.5283" y1="0.521788"
                            y2="15.4296">
              <stop stop-color="var(--primary-400)"/>
              <stop offset="1" stop-color="var(--primary-700)"/>
            </linearGradient>
            <linearGradient id="paint4_linear_7_2" gradientUnits="userSpaceOnUse" x1="35.5631" x2="27.7574" y1="0.11682"
                            y2="14.5441">
              <stop stop-color="var(--primary-400)"/>
              <stop offset="1" stop-color="var(--primary-700)"/>
            </linearGradient>
            <linearGradient id="paint5_linear_7_2" gradientUnits="userSpaceOnUse" x1="23.0068" x2="15.3473" y1="1.38676"
                            y2="15.3525">
              <stop stop-color="var(--primary-400)"/>
              <stop offset="1" stop-color="var(--primary-700)"/>
            </linearGradient>
      ...
      <ul ref="menu" class="list-none flex-grow-1 justify-content-end hidden md:flex absolute md:relative h-screen md:h-auto surface-card md:surface-ground m-0 z-5 w-full sm:w-6 md:w-full py-6 md:py-0"
        ...
        <li class="flex align-items-center">
          <Button v-styleclass="{ selector: '@grandparent', enterClass: 'hidden', enterActiveClass: 'px-fadein', leaveToClass: 'hidden' }"
                  class="m-0 mt-3 md:mt-0 ml-3 md:ml-5"
                  label="Buy Now" type="button"></Button>
        </li>
      </ul>
    </div>
    <div id="home" ref="home" class="landing-banner px-4 md:px-8 py-8 lg:flex flex-wrap">
      <div class="banner-left w-full lg:w-8">
        <span class="block font-normal mb-6 text-6xl sm:text-7xl xl:text-8xl text-900 w-12">Start Your Business With The All-In-One <b
            class="text-primary font-medium">FREYA</b> Dashboard Template!</span>
        <h4 class="font-normal text-900 m-0 mb-6 line-height-3 w-10" style="letter-spacing: 0.6px">
          Say goodbye to clunky, outdated dashboards and hello to modern, user-friendly design. With an array of pages
          and components at your fingertips, building your business dashboard has never been easier. Start streamlining
          your
          operations and making data-driven decisions with FREYA today!
        </h4>
        <Button class="mb-6" icon="pi pi-arrow-right" label="Learn More" size="large"></Button>

        <div class="logo-section relative w-full md:w-8 mt-6">
          <div class="fade-left h-2rem w-6rem block absolute top-0 left-0"
               style="background: linear-gradient(to right, var(--surface-ground), transparent); z-index: 2"></div>
          <div class="marquee-wrapper relative overflow-hidden flex gap-6">
            <div class="marquee flex gap-6" style="animation-duration: 50s">
              <img alt="" class="h-2rem" src="/demo/images/landing/logocloud/alfred-500.svg"/>
              <img alt="" class="h-2rem" src="/demo/images/landing/logocloud/bastion-500.svg"/>
              <img alt="" class="h-2rem" src="/demo/images/landing/logocloud/charot-500.svg"/>
              <img alt="" class="h-2rem" src="/demo/images/landing/logocloud/franki-500.svg"/>
              <img alt="" class="h-2rem" src="/demo/images/landing/logocloud/hodly-500.svg"/>
              <img alt="" class="h-2rem" src="/demo/images/landing/logocloud/hyper-500.svg"/>
              <img alt="" class="h-2rem" src="/demo/images/landing/logocloud/shodan-500.svg"/>
            </div>
            <div class="marquee flex gap-6" style="animation-duration: 50s">
              <img alt="" class="h-2rem" src="/demo/images/landing/logocloud/alfred-500.svg"/>
              <img alt="" class="h-2rem" src="/demo/images/landing/logocloud/bastion-500.svg"/>
          ...
          <div class="fade-right h-2rem w-6rem block absolute top-0 right-0"
               style="background: linear-gradient(to left, var(--surface-ground), transparent); z-index: 2"></div>
        </div>
      </div>
      <div class="banner-right w-4 hidden lg:block">
        <div id="ex1" class="cards w-full flex flex-column align-items-end mt-8 pl-3">
          <svg id="ex1-layer" class="w-full lg:mr-0" fill="none" viewBox="0 0 261 311"
    ...
    <div id="features" ref="features" class="landing-section px-4 md:px-8 py-8 mb-8">
      <div class="section-top lg:flex w-full gap-6 align-items-center mb-6">
        <span class="block font-normal text-6xl sm:text-7xl xl:text-8xl text-900 lg:w-8">Wide range of features and the stylish use of <b
            class="text-primary font-medium">PrimeVue</b> components</span>
        <div class="lg:w-4 lg:mt-0 mt-5">
          <h3 class="font-normal text-900 m-0 mb-6 w-full" style="letter-spacing: 0.6px">
            With customizability at the forefront, our templates can be tailored to your specific needs and preferences.
            Whether you're looking for a simple and intuitive interface or a more complex and feature-rich solution, our
            templates have you covered.
          </h3>
          <Button icon="pi pi-arrow-right" label="Learn More" size="large"></Button>
        </div>
      </div>
      <div class="feature-cards grid mt-8 pt-4">
        <div class="col-12 sm:col-6 lg:col-4">
          <div class="card p-0 h-full">
            <svg animateEnter="fadein" class="w-full border-round-3xl mb-4" fill="none" viewBox="0 0 443 257"
                 xmlns="http://www.w3.org/2000/svg">
              <mask id="mask0_436_2188" height="257" maskUnits="userSpaceOnUse" style="mask-type: alpha" width="443" x="0"
                    y="0">
                <rect fill="url(#paint0_linear_436_2188)" height="257" width="442.667"/>
              </mask>
              <g mask="url(#mask0_436_2188)">
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="-30.082" y="-14.1369"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="-30.082" y="-14.1369"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="141.918" y="-14.1369"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="141.918" y="-14.1369"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="313.918" y="-14.1369"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="313.918" y="-14.1369"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="-116.082" y="15.8631"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="-116.082" y="15.8631"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="55.918" y="15.8631"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="55.918" y="15.8631"/>
                </g>
                <g opacity="0.15">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="227.918" y="15.8631"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="227.918" y="15.8631"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="399.918" y="15.8631"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="399.918" y="15.8631"/>
                </g>
                <g opacity="0.15">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="-30.082" y="45.8631"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="-30.082" y="45.8631"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="141.918" y="45.8631"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="141.918" y="45.8631"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="313.918" y="45.8631"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="313.918" y="45.8631"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="-116.082" y="75.8631"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="-116.082" y="75.8631"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="55.918" y="75.8631"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="55.918" y="75.8631"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="227.918" y="75.8631"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="227.918" y="75.8631"/>
                </g>
                <g opacity="0.15">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="399.918" y="75.8631"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="399.918" y="75.8631"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="-30.082" y="105.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="-30.082" y="105.863"/>
                </g>
                <g opacity="0.15">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="141.918" y="105.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="141.918" y="105.863"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="313.918" y="105.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="313.918" y="105.863"/>
                </g>
                <g opacity="0.15">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="-116.082" y="135.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="-116.082" y="135.863"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="55.918" y="135.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="55.918" y="135.863"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="227.918" y="135.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="227.918" y="135.863"/>
                </g>
                <g opacity="0.15">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="399.918" y="135.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="399.918" y="135.863"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="-30.082" y="165.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="-30.082" y="165.863"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="141.918" y="165.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="141.918" y="165.863"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="313.918" y="165.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="313.918" y="165.863"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="-116.082" y="195.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="-116.082" y="195.863"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="55.918" y="195.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="55.918" y="195.863"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="227.918" y="195.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="227.918" y="195.863"/>
                </g>
                <g opacity="0.05">
                  <rect fill="var(--primary-500)" height="15" rx="6.5" width="155" x="399.918" y="195.863"/>
                  <rect height="15" rx="6.5" stroke="var(--primary-300)" width="155" x="399.918" y="195.863"/>
                </g>
                <rect fill="var(--primary-300)" height="45" rx="13.5" style="opacity: 0.9" width="273.565" x="84.5507"
                      y="97.8894"/>
                <path
                ...
                />
                <rect height="45" rx="13.5" stroke="var(--primary-300)" width="273.565" x="84.5507" y="97.8894"/>
              </g>
              <defs>
                <linearGradient id="paint0_linear_436_2188" gradientUnits="userSpaceOnUse" x1="221.333" x2="221.333" y1="0"
                                y2="257">
        ...
        <div class="col-12 sm:col-6 lg:col-4">
          <div class="card p-0 h-full">
            <svg animateEnter="fadein" class="w-full border-round-3xl mb-4" fill="none" viewBox="0 0 444 257"
                 xmlns="http://www.w3.org/2000/svg">
              <mask id="mask0_436_2247" height="257" maskUnits="userSpaceOnUse" style="mask-type: alpha" width="444" x="0"
                    y="0">
                <rect fill="url(#paint0_linear_436_2247)" height="257" transform="translate(0.666656)" width="442.667"/>
              </mask>
              <g mask="url(#mask0_436_2247)">
                <g clip-path="url(#clip0_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip1_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip2_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip3_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip4_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip5_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip6_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip7_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip8_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip9_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip10_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip11_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip12_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip13_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip14_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip15_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip16_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip17_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip18_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip19_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip20_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip21_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip22_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip23_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip24_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip25_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip26_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip27_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip28_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip29_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip30_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip31_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip32_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip33_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip34_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip35_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip36_436_2247)" opacity="0.05">
                  <path
                ...
                <g clip-path="url(#clip37_436_2247)" opacity="0.05">
                  <path
                ...
                <rect fill="var(--primary-300)" height="58" rx="25.5" style="opacity: 0.9" width="58" x="192.866"
                      y="89.0972"/>
                ...
                <rect height="58" rx="25.5" stroke="var(--primary-300)" width="58" x="192.866" y="89.0972"/>
              </g>
              <defs>
                <linearGradient id="paint0_linear_436_2247" gradientUnits="userSpaceOnUse" x1="221.333" x2="221.333" y1="0"
                                y2="257">
                  <stop offset="0.750409" stop-color="white"/>
                  <stop offset="1" stop-color="white" stop-opacity="0"/>
                </linearGradient>
                <clipPath id="clip0_436_2247">
                  <rect fill="white" height="42" transform="translate(14.7972 0.019165)" width="42"/>
                </clipPath>
                <clipPath id="clip1_436_2247">
                  <rect fill="white" height="42" transform="translate(76.8648 0.019165)" width="42"/>
                </clipPath>
                <clipPath id="clip2_436_2247">
                  <rect fill="white" height="42" transform="translate(138.932 0.019165)" width="42"/>
                </clipPath>
                <clipPath id="clip3_436_2247">
                  <rect fill="white" height="42" transform="translate(201 0.019165)" width="42"/>
                </clipPath>
                <clipPath id="clip4_436_2247">
                  <rect fill="white" height="42" transform="translate(263.068 0.019165)" width="42"/>
                </clipPath>
                <clipPath id="clip5_436_2247">
                  <rect fill="white" height="42" transform="translate(325.135 0.019165)" width="42"/>
                </clipPath>
                <clipPath id="clip6_436_2247">
                  <rect fill="white" height="42" transform="translate(387.203 0.019165)" width="42"/>
                </clipPath>
                <clipPath id="clip7_436_2247">
                  <rect fill="white" height="42" transform="translate(-16.2366 56.0192)" width="42"/>
                </clipPath>
                <clipPath id="clip8_436_2247">
                  <rect fill="white" height="42" transform="translate(45.831 56.0192)" width="42"/>
                </clipPath>
                <clipPath id="clip9_436_2247">
                  <rect fill="white" height="42" transform="translate(107.899 56.0192)" width="42"/>
                </clipPath>
                <clipPath id="clip10_436_2247">
                  <rect fill="white" height="42" transform="translate(169.966 56.0192)" width="42"/>
                </clipPath>
                <clipPath id="clip11_436_2247">
                  <rect fill="white" height="42" transform="translate(232.034 56.0192)" width="42"/>
                </clipPath>
                <clipPath id="clip12_436_2247">
                  <rect fill="white" height="42" transform="translate(294.101 56.0192)" width="42"/>
                </clipPath>
                <clipPath id="clip13_436_2247">
                  <rect fill="white" height="42" transform="translate(356.169 56.0192)" width="42"/>
                </clipPath>
                <clipPath id="clip14_436_2247">
                  <rect fill="white" height="42" transform="translate(418.237 56.0192)" width="42"/>
                </clipPath>
                <clipPath id="clip15_436_2247">
                  <rect fill="white" height="42" transform="translate(14.7971 112.019)" width="42"/>
                </clipPath>
                <clipPath id="clip16_436_2247">
                  <rect fill="white" height="42" transform="translate(76.8648 112.019)" width="42"/>
                </clipPath>
                <clipPath id="clip17_436_2247">
                  <rect fill="white" height="42" transform="translate(138.932 112.019)" width="42"/>
                </clipPath>
                <clipPath id="clip18_436_2247">
                  <rect fill="white" height="42" transform="translate(201 112.019)" width="42"/>
                </clipPath>
                <clipPath id="clip19_436_2247">
                  <rect fill="white" height="42" transform="translate(263.068 112.019)" width="42"/>
                </clipPath>
                <clipPath id="clip20_436_2247">
                  <rect fill="white" height="42" transform="translate(325.135 112.019)" width="42"/>
                </clipPath>
                <clipPath id="clip21_436_2247">
                  <rect fill="white" height="42" transform="translate(387.203 112.019)" width="42"/>
                </clipPath>
                <clipPath id="clip22_436_2247">
                  <rect fill="white" height="42" transform="translate(-16.2366 168.019)" width="42"/>
                </clipPath>
                <clipPath id="clip23_436_2247">
                  <rect fill="white" height="42" transform="translate(45.831 168.019)" width="42"/>
                </clipPath>
                <clipPath id="clip24_436_2247">
                  <rect fill="white" height="42" transform="translate(107.899 168.019)" width="42"/>
                </clipPath>
                <clipPath id="clip25_436_2247">
                  <rect fill="white" height="42" transform="translate(169.966 168.019)" width="42"/>
                </clipPath>
                <clipPath id="clip26_436_2247">
                  <rect fill="white" height="42" transform="translate(232.034 168.019)" width="42"/>
                </clipPath>
                <clipPath id="clip27_436_2247">
                  <rect fill="white" height="42" transform="translate(294.101 168.019)" width="42"/>
                </clipPath>
                <clipPath id="clip28_436_2247">
                  <rect fill="white" height="42" transform="translate(356.169 168.019)" width="42"/>
                </clipPath>
                <clipPath id="clip29_436_2247">
                  <rect fill="white" height="42" transform="translate(418.237 168.019)" width="42"/>
                </clipPath>
                <clipPath id="clip30_436_2247">
                  <rect fill="white" height="42" transform="translate(-3.98247 224.019)" width="42"/>
                </clipPath>
                <clipPath id="clip31_436_2247">
                  <rect fill="white" height="42" transform="translate(54.584 224.019)" width="42"/>
                </clipPath>
                <clipPath id="clip32_436_2247">
                  <rect fill="white" height="42" transform="translate(113.15 224.019)" width="42"/>
                </clipPath>
                <clipPath id="clip33_436_2247">
                  <rect fill="white" height="42" transform="translate(171.717 224.019)" width="42"/>
                </clipPath>
                <clipPath id="clip34_436_2247">
                  <rect fill="white" height="42" transform="translate(230.283 224.019)" width="42"/>
                </clipPath>
                <clipPath id="clip35_436_2247">
                  <rect fill="white" height="42" transform="translate(288.85 224.019)" width="42"/>
                </clipPath>
                <clipPath id="clip36_436_2247">
                  <rect fill="white" height="42" transform="translate(347.416 224.019)" width="42"/>
                </clipPath>
                <clipPath id="clip37_436_2247">
                  <rect fill="white" height="42" transform="translate(405.982 224.019)" width="42"/>
                </clipPath>
                <clipPath id="clip38_436_2247">
                  <rect fill="white" height="31" transform="translate(206.366 102.597)" width="31"/>
                </clipPath>
              </defs>
            </svg>
        ...
        <div class="col-12 sm:col-6 lg:col-4">
          <div class="card p-0 h-full">
            <svg animateEnter="fadein" class="w-full border-round-3xl mb-4" fill="none" viewBox="0 0 443 257"
                 xmlns="http://www.w3.org/2000/svg">
              <mask id="mask0_436_2322" height="257" maskUnits="userSpaceOnUse" style="mask-type: alpha" width="443" x="0"
                    y="0">
                <rect fill="url(#paint0_linear_436_2322)" height="257" transform="translate(0.333313)" width="442.667"/>
              </mask>
              <g mask="url(#mask0_436_2322)">
                <g opacity="0.75">
                  <rect fill="var(--surface-ground)" height="53.4844" rx="16.2779" width="401.133" x="20.9327"
                        y="15.1779"/>
                  <rect fill="var(--surface-card)" height="16.2779" rx="8.13893" width="224.402" x="82.5561"
                        y="33.7811"/>
                ...
                <rect fill="var(--primary-300)" height="26" opacity="0.8" rx="5.5" width="369" x="36.9992" y="99.3926"/>
                <rect fill="var(--primary-700)" height="7" rx="3" width="350" x="46.4992" y="108.893"/>
                <rect height="26" rx="5.5" stroke="var(--primary-300)" width="369" x="36.9992" y="99.3926"/>

                <rect fill="var(--primary-500)" height="6.97623" opacity="0.5" rx="2.90676" width="305.791" x="37.0806"
                      y="138.682"/>
                <rect height="6.97623" rx="2.90676" stroke="var(--primary-300)" stroke-width="1.1627" width="305.791" x="37.0806"
                      y="138.682"/>

                <rect fill="var(--primary-500)" height="6.97623" opacity="0.5" rx="2.90676" width="266.259" x="37.0806"
                      y="156.123"/>
                <rect height="6.97623" rx="2.90676" stroke="var(--primary-300)" stroke-width="1.1627" width="266.259" x="37.0806"
                      y="156.123"/>

                <g opacity="0.75">
                  <rect fill="var(--surface-ground)" height="23.2541" rx="6.97623" width="349.974" x="36.4992"
                        y="185.819"/>
                  <rect fill="var(--surface-ground)" height="8.13893" rx="3.48811" width="306.954" x="36.4992"
                        y="221.282"/>
                  <rect fill="var(--surface-ground)" height="8.13893" rx="3.48811" width="267.422" x="36.4992"
                        y="238.722"/>
                </g>
              </g>
              <defs>
                <linearGradient id="paint0_linear_436_2322" gradientUnits="userSpaceOnUse" x1="221.333" x2="221.333" y1="0"
                                y2="257">
                  <stop offset="0.750409" stop-color="white"/>
                  <stop offset="1" stop-color="white" stop-opacity="0"/>
                </linearGradient>
                <clipPath id="clip0_436_2322">
                  <rect fill="white" height="24.4168" transform="translate(39.536 29.7116)" width="24.4168"/>
                </clipPath>
              </defs>
            </svg>
        ...
        <div class="col-12 sm:col-6 lg:col-4">
          <div class="card p-0 h-full">
            <svg animateEnter="fadein" class="w-full border-round-3xl mb-4" fill="none" viewBox="0 0 443 257"
                 xmlns="http://www.w3.org/2000/svg">
              <mask id="mask0_436_2345" height="257" maskUnits="userSpaceOnUse" style="mask-type: alpha" width="443" x="0"
                    y="0">
                <rect fill="url(#paint0_linear_436_2345)" height="257" width="442.667"/>
              </mask>
              <g mask="url(#mask0_436_2345)">
                <rect fill="var(--surface-card)" height="225.401" rx="7.94682" width="382.892" x="28.9248" y="26.5128"/>
                <rect height="225.401" rx="7.94682" stroke="var(--primary-500)" stroke-width="1.44488" width="382.892" x="28.9248"
                      y="26.5128"/>
                <rect fill="var(--surface-card)" height="179.165" rx="7.94682" width="161.826" x="139.458" y="49.6307"/>
                <circle cx="220.371" cy="212.749" r="6.57779" stroke="var(--primary-600)"/>
                <rect height="179.165" rx="7.94682" stroke="var(--primary-500)" stroke-width="1.44488" width="161.826" x="139.458"
                      y="49.6307"/>
                <rect fill="var(--primary-500)" height="111.256" opacity="0.5" rx="7.94682" width="59.24" x="190.751"
                      y="83.5854"/>
                <circle cx="220.371" cy="177.957" fill="var(--primary-300)" r="6.57779"/>
                <rect height="111.256" rx="7.94682" stroke="var(--primary-500)" stroke-width="1.44488" width="59.24" x="190.751"
                      y="83.5854"/>
              </g>
              <defs>
                <linearGradient id="paint0_linear_436_2345" gradientUnits="userSpaceOnUse" x1="221.333" x2="221.333" y1="0"
                                y2="257">
                  <stop offset="0.750409" stop-color="white"/>
                  <stop offset="1" stop-color="white" stop-opacity="0"/>
                </linearGradient>
        ...
        <div class="col-12 sm:col-6 lg:col-4">
          <div class="card p-0 h-full">
            <svg animateEnter="fadein" class="w-full border-round-3xl mb-4" fill="none" viewBox="0 0 444 257"
                 xmlns="http://www.w3.org/2000/svg">
              <mask id="mask0_436_2360" height="257" maskUnits="userSpaceOnUse" style="mask-type: alpha" width="444" x="0"
                    y="0">
                <rect fill="url(#paint0_linear_436_2360)" height="257" transform="translate(0.666656)" width="442.667"/>
              </mask>
              <g mask="url(#mask0_436_2360)">
                ...
                <path
                    ...
                    stroke-width="2"
                />
                <rect fill="var(--primary-500)" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 336.923 66.7666)"
                      width="65.178"
                      y="0.561843"/>
                ...
                <rect height="65.1791" rx="32.589" stroke="var(--primary-300)" stroke-width="1.12376"
                      transform="matrix(0.866044 0.499967 -0.866044 0.499967 336.923 66.7666)"
                      width="65.178" y="0.561843"/>

                <rect fill="var(--primary-500)" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 222.081 127.852)"
                      width="65.178"
                      y="0.561843"/>
                ...
                <rect height="65.1791" rx="32.589" stroke="var(--primary-300)" stroke-width="1.12376"
                      transform="matrix(0.866044 0.499967 -0.866044 0.499967 222.081 127.852)"
                      width="65.178" y="0.561843"/>

                <rect fill="var(--primary-500)" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 222.109 10.8927)"
                      width="65.178"
                      y="0.561843"/>
                ...
                <rect height="65.1791" rx="32.589" stroke="var(--primary-300)" stroke-width="1.12376"
                      transform="matrix(0.866044 0.499967 -0.866044 0.499967 222.109 10.8927)"
                      width="65.178" y="0.561843"/>

                <rect fill="var(--primary-500)" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 107.267 71.9784)"
                      width="65.178"
                      y="0.561843"/>
                ...
                <rect height="65.1791" rx="32.589" stroke="var(--primary-300)" stroke-width="1.12376"
                      transform="matrix(0.866044 0.499967 -0.866044 0.499967 107.267 71.9784)"
                      width="65.178" y="0.561843"/>
              </g>
              <defs>
                <linearGradient id="paint0_linear_436_2360" gradientUnits="userSpaceOnUse" x1="221.333" x2="221.333" y1="0"
                                y2="257">
                  <stop offset="0.750409" stop-color="white"/>
                  <stop offset="1" stop-color="white" stop-opacity="0"/>
                </linearGradient>
                <clipPath id="clip0_436_2360">
                  <rect fill="white" height="34.8365" transform="matrix(0.866044 0.499967 -0.866044 0.499967 336.436 82.2176)"
                        width="34.8365"/>
                </clipPath>
                <clipPath id="clip1_436_2360">
                  <rect fill="white" height="34.8365" transform="matrix(0.866044 0.499967 -0.866044 0.499967 221.594 143.303)"
                        width="34.8365"/>
                </clipPath>
                <clipPath id="clip2_436_2360">
                  <rect fill="white" height="34.8365" transform="matrix(0.866044 0.499967 -0.866044 0.499967 221.622 26.3437)"
                        width="34.8365"/>
                </clipPath>
                <clipPath id="clip3_436_2360">
                  <rect fill="white" height="34.8365" transform="matrix(0.866044 0.499967 -0.866044 0.499967 106.78 87.4294)"
                        width="34.8365"/>
                </clipPath>
              </defs>
            </svg>
        ...
        <div class="col-12 sm:col-6 lg:col-4">
          <div class="card p-0 h-full">
            <svg animateEnter="fadein" class="w-full border-round-3xl mb-4" fill="none" viewBox="0 0 443 257"
                 xmlns="http://www.w3.org/2000/svg">
              <mask id="mask0_436_2387" height="257" maskUnits="userSpaceOnUse" style="mask-type: alpha" width="443" x="0"
                    y="0">
                <rect fill="url(#paint0_linear_436_2387)" height="257" transform="translate(0.333313)" width="442.667"/>
              </mask>
              <g mask="url(#mask0_436_2387)">
                <mask id="mask1_436_2387" height="189" maskUnits="userSpaceOnUse" style="mask-type: alpha" width="219" x="124"
                      y="34">
                  <ellipse cx="108.636" cy="94.2142" fill="url(#paint1_radial_436_2387)" rx="108.636"
                           ry="94.2142" transform="matrix(-1 0 0 1 342.236 34.2857)"/>
                </mask>
                ...
                <g opacity="0.5">
                  <mask id="mask2_436_2387" height="143" maskUnits="userSpaceOnUse" style="mask-type: alpha" width="166"
                        x="209" y="57">
                    <ellipse cx="82.2843" cy="71.3611" fill="url(#paint2_radial_436_2387)" rx="82.2843"
                             ry="71.3611" transform="matrix(-1 0 0 1 374.163 57.139)"/>
                  </mask>
                ...
                <g opacity="0.25">
                  <mask id="mask3_436_2387" height="95" maskUnits="userSpaceOnUse" style="mask-type: alpha" width="109"
                        x="288" y="81">
                    <ellipse cx="54.0017" cy="46.833" fill="url(#paint3_radial_436_2387)" rx="54.0017"
                             ry="46.833" transform="matrix(-1 0 0 1 396.238 81.667)"/>
                  </mask>
                ...
                <mask id="mask4_436_2387" height="189" maskUnits="userSpaceOnUse" style="mask-type: alpha" width="218" x="101"
                      y="34">
                  <ellipse cx="209.733" cy="128.5" fill="url(#paint4_radial_436_2387)" rx="108.636" ry="94.2142"/>
                </mask>
                ...
                <g opacity="0.5">
                  <mask id="mask5_436_2387" height="143" maskUnits="userSpaceOnUse" style="mask-type: alpha" width="165"
                        x="69" y="57">
                    <ellipse cx="151.455" cy="128.5" fill="url(#paint5_radial_436_2387)" rx="82.2843" ry="71.3611"/>
                  </mask>
                ...
                <g opacity="0.25">
                  <mask id="mask6_436_2387" height="95" maskUnits="userSpaceOnUse" style="mask-type: alpha" width="109"
                        x="47" y="81">
                    <ellipse cx="101.097" cy="128.5" fill="url(#paint6_radial_436_2387)" rx="54.0017" ry="46.833"/>
                  </mask>
                ...
                <rect fill="var(--primary-500)" height="141.806" opacity="0.89" rx="70.9032" width="163.653" x="139.84"
                      y="57.5968"/>
                <path
                    ...
                    fill="var(--primary-700)"
                />
                <rect height="141.806" rx="70.9032" stroke="var(--primary-300)" stroke-width="0.915632" width="163.653" x="139.84"
                      y="57.5968"/>
              </g>
              <defs>
                <linearGradient id="paint0_linear_436_2387" gradientUnits="userSpaceOnUse" x1="221.333" x2="221.333" y1="0"
                                y2="257">
                  <stop offset="0.750409" stop-color="white"/>
                  <stop offset="1" stop-color="white" stop-opacity="0"/>
                </linearGradient>
                <radialGradient id="paint1_radial_436_2387" cx="0" cy="0" gradientTransform="translate(217.271 94.2142) rotate(180) scale(209.792 143.525)" gradientUnits="userSpaceOnUse"
                                r="1">
                  <stop offset="0.887131" stop-color="white" stop-opacity="0"/>
                  <stop offset="1" stop-color="var(--primary-700)"/>
                </radialGradient>
                <radialGradient id="paint2_radial_436_2387" cx="0" cy="0" gradientTransform="translate(164.569 71.3611) rotate(180) scale(158.904 151.525)" gradientUnits="userSpaceOnUse"
                                r="1">
                  <stop offset="0.776042" stop-color="var(--primary-700)" stop-opacity="0"/>
                  <stop offset="1" stop-color="var(--primary-700)"/>
                </radialGradient>
                <radialGradient id="paint3_radial_436_2387" cx="0" cy="0" gradientTransform="translate(108.003 46.833) rotate(180) scale(104.286 99.4435)" gradientUnits="userSpaceOnUse"
                                r="1">
                  <stop offset="0.776042" stop-color="var(--primary-700)" stop-opacity="0"/>
                  <stop offset="1" stop-color="var(--primary-700)"/>
                </radialGradient>
                <radialGradient id="paint4_radial_436_2387" cx="0" cy="0" gradientTransform="translate(318.368 128.5) rotate(180) scale(209.792 143.525)" gradientUnits="userSpaceOnUse"
                                r="1">
                  <stop offset="0.887131" stop-color="white" stop-opacity="0"/>
                  <stop offset="1" stop-color="var(--primary-700)"/>
                </radialGradient>
                <radialGradient id="paint5_radial_436_2387" cx="0" cy="0" gradientTransform="translate(233.739 128.5) rotate(180) scale(158.904 151.525)" gradientUnits="userSpaceOnUse"
                                r="1">
                  <stop offset="0.776042" stop-color="var(--primary-700)" stop-opacity="0"/>
                  <stop offset="1" stop-color="var(--primary-700)"/>
                </radialGradient>
                <radialGradient id="paint6_radial_436_2387" cx="0" cy="0" gradientTransform="translate(155.099 128.5) rotate(180) scale(104.286 99.4435)" gradientUnits="userSpaceOnUse"
                                r="1">
                  <stop offset="0.776042" stop-color="var(--primary-700)" stop-opacity="0"/>
                  <stop offset="1" stop-color="var(--primary-700)"/>
                </radialGradient>
    ...
    <div id="customizations" ref="customizations" class="landing-section px-4 md:px-8 py-8 mt-8">
      <div class="section-top flex w-full flex-column gap-6 align-items-center justify-content-center mb-6">
        ...
        <h4 class="lg:w-8 font-normal text-900 m-0 mb-6 text-center line-height-3" style="letter-spacing: 0.6px">
          Take control of your dashboard with FREYA. Make it your own with customizations to suit your business needs.
          Get creative and elevate your operations with FREYA's Config feature. <br/><b class="font-medium">Try it
          now!</b>
        </h4>
      </div>
      <div class="video relative" style="max-width: 62rem; margin: 0 auto">
        <img alt="" class="w-full border-round-3xl mb-4" src="/demo/images/landing/image-3.png"/>
        <Button class="absolute top-50 right-50 text-3xl" icon="pi pi-play text-8xl ml-3" rounded
                style="margin-right: -5rem; margin-top: -5rem; height: 10rem; width: 10rem" @click="showModalDialog()"></Button>
      </div>
      <Dialog v-model:visible="displayModal" :draggable="false" :modal="true"
              :pt="{ content: { style: 'flex-grow:1' } }" :resizable="false" :style="{ width: '80vw', height: '45vw' }" header="Video Content">
        <iframe
    ...
    <div id="apps" ref="apps" class="landing-section px-4 md:px-8 py-8 mt-8">
      ...
      <div class="content lg:flex justify-content-between gap-6">
        <div class="left lg:w-6">
          <h4 class="w-11 font-normal text-900 m-0 mb-6 line-height-3" style="letter-spacing: 0.6px">
            Streamline your project building process and save valuable time with the ready-to-use applications offered
            by <b class="font-medium">FREYA</b>. From Chat to Mail, Product Reviews, Checkout and more, our suite of
            pre-made tools
            will have you up and running in no time. Start fast-tracking your success and take advantage of the
            time-saving features of <b class="font-medium">FREYA today.</b>
          </h4>
          <ul class="list-none p-0 m-0">
            <li class="mb-4 flex align-items-center">
              <a :style="activeLink == 0 ? 'color:var(--primary-color) !important' : ''"
                 class="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer"
                 @mouseover="changeImageOnHover(0)">Chat </a>
              <i v-if="activeLink == 0" class="pi pi-arrow-right text-4xl text-primary ml-3"></i>
            </li>
            <li class="mb-4 flex align-items-center">
              <a :style="activeLink == 1 ? 'color:var(--primary-color) !important' : ''"
                 class="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer"
                 @mouseover="changeImageOnHover(1)">Mail</a>
              <i v-if="activeLink == 1" class="pi pi-arrow-right text-4xl text-primary ml-3"></i>
            </li>

            <li class="mb-4 flex align-items-center">
              <a :style="activeLink == 3 ? 'color:var(--primary-color) !important' : ''"
                 class="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer"
                 @mouseover="changeImageOnHover(2)">Task
                List</a>
              <i v-if="activeLink == 3" class="pi pi-arrow-right text-4xl text-primary ml-3"></i>
            </li>
            <li class="mb-4 flex align-items-center">
              <a :style="activeLink == 4 ? 'color:var(--primary-color) !important' : ''"
                 class="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer"
                 @mouseover="changeImageOnHover(3)">Blog</a>
              <i v-if="activeLink == 4" class="pi pi-arrow-right text-4xl text-primary ml-3"></i>
            </li>
          </ul>
        </div>
        <div class="right lg:w-6 mt-5 lg:mt-0">
          <img :src="activeImage" alt="" animateEnter="fadein" class="w-full border-round-3xl mb-4"/>
        </div>
      </div>
    </div>
    <div id="pricing" ref="pricing" class="landing-section px-4 md:px-8 py-8 mt-8">
      <div class="surface-ground px-4 py-8 md:px-6 lg:px-8 bg-no-repeat bg-cover"
           style="border-radius: 24px; background: linear-gradient(to left bottom, var(--primary-lighter-color), var(--surface-0))">
        <div class="flex flex-wrap align-items-center">
          <div class="w-full lg:w-6 lg:pr-8">
            <div class="text-900 font-normal text-6xl sm:text-7xl xl:text-8xl mb-4">Pricing</div>
            <h4 class="text-900 font-normal mb-4 lg:mb-0 line-height-3" style="letter-spacing: 0.6px">Lorem ipsum dolor
              sit, amet consectetur adipisicing elit. Velitnumquam eligendi quos.</h4>
          </div>
        ...
        <div class="flex flex-wrap mt-5 -mx-3">
          <div class="w-full lg:w-4 p-3">
            <div class="p-4 h-full surface-card" style="border-radius: 24px">
              ...
              <Button class="lg:w-full font-medium p-2" icon="pi pi-arrow-right" iconPos="right" label="Create Account"
                      outlined size="large"></Button>
              <p class="text-sm line-height-3 mb-0 mt-5 line-height-3">Lorem ipsum dolor sit, amet consectetur
                adipisicing elit.</p>
            </div>
          </div>
          <div class="w-full lg:w-4 p-3">
            <div class="p-4 h-full surface-card" style="border-radius: 24px">
              ...
              <Button class="lg:w-full font-medium p-2" icon="pi pi-arrow-right" iconPos="right" label="Proceed Monthly"
                      size="large"></Button>
              <p class="text-sm line-height-3 mb-0 mt-5">Nec ultrices dui sapien eget. Amet nulla facilisi morbi
                tempus.</p>
            </div>
          </div>
          <div class="w-full lg:w-4 p-3">
            <div class="p-4 h-full flex flex-column surface-card" style="border-radius: 24px">
              <div class="flex flex-row justify-content-between mb-5 align-items-center">
                ...
                <span class="500 text-green-500 font-semibold px-2 py-1 border-round"
                      style="background-color: rgba(76, 175, 80, 0.1)">🎉 Save 20%</span>
              </div>
              <div class="flex align-items-center mb-5">
                <span class="text-900 font-bold text-5xl">$275</span>
                <span class="font-medium text-500 ml-2">per year</span>
              </div>
              <Button class="lg:w-full font-medium p-2" icon="pi pi-arrow-right" iconPos="right" label="Proceed Yearly"
                      size="large"></Button>
      ...
      <div class="pt-8 pb-6">
        <div class="grid pb-6 border-bottom-1 border-300">
          <div class="col-12 md:col-3">
            ...
            <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">About
              Us</a>
            <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">News</a>
            <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">Investor
              Relations</a>
            <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">Careers</a>
            <a class="text-700 block cursor-pointer line-height-3 hover:text-primary transition-duration-200">Media
              Kit</a>
          </div>
          <div class="col-12 md:col-3">
            <div class="text-900 font-bold line-height-3 mb-3">Resourses</div>
            <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">Get
              Started</a>
            <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">Learn</a>
            <a class="text-700 block cursor-pointer line-height-3 hover:text-primary transition-duration-200">Case
              Studies</a>
          </div>
          <div class="col-12 md:col-3">
          ...
          <div class="col-12 md:col-3">
            ...
            <InputText class="w-full" placeholder="Enter your email"/>
            <Button class="px-5 mt-3 py-3" label="Join"></Button>
          </div>
        </div>
        <div class="flex flex-wrap align-items-center justify-content-between mt-6">
          <div class="flex align-items-center justify-content-start md:mb-0 mb-3">
            <svg animateEnter="fadein" fill="none" height="32" viewBox="0 0 66 19" xmlns="http://www.w3.org/2000/svg">
              <path
                  d="M0 0H4.99056V3.20992L14.1395 1.39922V5.5969L4.99056 7.40759V8.80682L14.1395 6.99612V11.1938L4.99056 13.0045V16.7907H0V0Z"
                  fill="url(#paint0_linear_7_2)"/>
              <path
          ...
          <div class="flex align-items-center justify-content-between md:mb-0 mb-3">
            ...
            <a class="text-700 cursor-pointer md:ml-5 ml-2 hover:text-primary transition-duration-200">Privacy
              Policy</a>
            <a class="text-700 cursor-pointer md:ml-5 ml-2 hover:text-primary transition-duration-200">Terms of
              Service</a>
          </div>
