      ...
      <div class="card">
        <Toolbar class="mb-4">
          <template v-slot:start>
            <div class="my-2">
              ...
              <Button :disabled="!selectedProducts || !selectedProducts.length" icon="pi pi-trash" label="Delete" severity="danger"
          ...
          <template v-slot:end>
            <FileUpload :maxFileSize="1000000" accept="image/*" chooseLabel="Import" class="mr-2 inline-block" label="Import"
                        mode="basic"/>
            <Button icon="pi pi-upload" label="Export" severity="help" @click="exportCSV($event)"/>
          </template>
        </Toolbar>
        ...
        >
          <template #header>
            <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
              ...
              <span class="block mt-2 md:mt-0 p-input-icon-left">
                                ...
                                <InputText v-model="filters['global'].value" class="w-full sm:w-auto"
                                           placeholder="Search..."/>
                            </span>
            </div>
          </template>
          ...
          <Column headerStyle="min-width:10rem;">
            <template #body="slotProps">
              <Button class="mr-2" icon="pi pi-pencil" rounded severity="success" @click="editProduct(slotProps.data)"/>
              <Button class="mt-2" icon="pi pi-trash" rounded severity="warning"
        ...
        <Dialog v-model:visible="productDialog" :modal="true" :style="{ width: '450px' }" class="p-fluid"
          ...
          <img v-if="product.image" :alt="product.image" :src="'/demo/images/product/' + product.image" class="mt-0 mx-auto mb-5 block shadow-2"
               width="150"/>
          <div class="field">
          ...
          <div class="formgrid grid">
            <div class="field col">
              ...
              <InputNumber id="price" v-model="product.price" :class="{ 'p-invalid': submitted && !product.price }" :required="true" currency="USD"
          ...
          <template #footer>
            ...
            <Button icon="pi pi-check" label="Save" text="" @click="saveProduct"/>
          </template>
        </Dialog>
