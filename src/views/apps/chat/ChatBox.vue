    ...
    <div class="flex align-items-center border-bottom-1 surface-border p-3 lg:p-6">
      <div class="relative flex align-items-center mr-3">
        ...
        <span
            ...
            class="w-1rem h-1rem border-circle border-2 surface-border absolute bottom-0 right-0"
        ></span>
      </div>
      <div class="mr-2">
        <span class="text-900 font-semibold block">{{ user.name }}</span>
        <span class="text-700">Social Media Expert</span>
      </div>
    </div>
    <div
        class="user-message-container p-3 md:px-4 lg:px-6 lg:py-4 mt-2 overflow-y-auto"
