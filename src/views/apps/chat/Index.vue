...
<template>
  <h3 class="font-bold text-5xl text-900 mb-6">Social Media AI Expert</h3>

  <div class="flex flex-column md:flex-row gap-5" style="min-height: 81vh">
    <div class="md:w-25rem card p-0">
      <ChatSidebar :users="users" @change:active:user="changeActiveUser"></ChatSidebar>
    </div>
    <div class="flex-1 card p-0">
      <ChatBox :user="findActiveUser()" @send:message="sendMessage"></ChatBox>
    </div>
  </div>
</template>
