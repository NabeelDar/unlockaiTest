...
<template>
  <div class="card">
    <div class="flex justify-content-between align-items-center mb-5">
      ...
      <Button class="font-semibold" icon="pi pi-plus" label="Create Task" outlined @click="openCreateDialog()"></Button>
    </div>
    <List :task-list="todo" title="ToDo" @checkbox:change="onCheckboxChange" @delete:task="onDeleteTask"
          @open:edit:dialog="openEditDialog"></List>
    <List :task-list="completed" title="Completed" @checkbox:change="onCheckboxChange" @delete:task="onDeleteTask"
          @open:edit:dialog="openEditDialog"></List>
  </div>

  <Dialog v-model:visible="dialogConfig.visible" :header="dialogConfig.header || ''" class="mx-3 sm:mx-0 sm:w-full md:w-8 lg:w-6"
