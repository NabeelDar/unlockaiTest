  ...
  <div>
    <div
      ...
      <div class="flex align-items-center md:justify-content-start">
        <Button class="md:mr-3" icon="pi pi-chevron-left" plain text type="button" @click="goBack()"></Button>
        <Avatar v-if="mail && mail.image" :image="'/demo/images/avatar/' + mail.image" class="border-2 surface-border" shape="circle"
                size="large"></Avatar>
      ...
      <div class="flex align-items-center justify-content-end column-gap-3 px-4 md:px-0">
        ...
        <Button class="flex-shrink-0" icon="pi pi-reply" plain text type="button"></Button>
        <Button class="flex-shrink-0" icon="pi pi-ellipsis-v" plain text type="button"></Button>
      </div>
    </div>
    <div class="surface-border border-1 border-round p-4">
      ...
      <div class="flex column-gap-3 justify-content-end mt-3">
        ...
        <Button icon="pi pi-send" label="Send" type="button" @click="sendMail()"></Button>
      </div>
    </div>
  </div>
</template>
