...
<template>
  <div class="card">
    <DataView :rows="3" :sortField="sortField" :sortOrder="sortOrder" :value="totalBlogs" layout="grid" paginator>
      <template #header>
        <div class="flex flex-column sm:flex-row sm:align-items-center sm:justify-content-between gap-3">
          ...
          <Dropdown v-model="sortKey" :options="sortOptions" class="w-full md:w-15rem" optionLabel="label"
        ...
        <div class="col-12 md:col-4">
          <div class="p-3">
            <div class="border-1 surface-border cursor-pointer z-index border-round">
              <div class="relative">
                <img :alt="data.description.split(' ', 1)" :src="data.coverImage" class="w-full"/>
                <img :alt="data.description.split(' ', 1)" :src="data.profile"
                     :style="{ bottom: '-1.5rem', right: '1.5rem' }" class="flex absolute w-4rem h-4rem"/>
              </div>
              <div class="p-4">
  ...
  <div class="card">
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
      ...
      <div class="text-700 text-xl line-height-3 mb-5">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
      ...
      <div class="grid nogutter">
        <div class="col-12 lg:col-4 p-4">
          ...
          <div class="text-900 font-medium text-xl line-height-3 mb-4">Why Earth&lsquo;s most beloved creatures are
            headed toward extinction
          </div>
          <div class="font-sm text-700 line-height-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
        ...
        <div class="col-12 lg:col-4 p-4">
          ...
          <div class="text-900 font-medium text-xl line-height-3 mb-4">Only one-third of tropical rainforests remain
            intact, study says
          </div>
          <div class="font-sm text-700 line-height-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
        ...
        <div class="col-12 lg:col-4 p-4">
          ...
          <div class="text-900 font-medium text-xl line-height-3 mb-4">Does planting a tree really offset your carbon
            footprint?
          </div>
          <div class="font-sm text-700 line-height-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
