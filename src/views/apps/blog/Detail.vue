...
<template>
  <div class="card">
    <div class="flex justify-content-between flex-column-reverse md:flex-row align-items-center">
      <div>
        <div class="text-xl text-900 mb-4 mt-4 md:mt-0 text-center md:text-left font-semibold md:pr-4">How To Get
          Started Tutorial
        </div>
      ...
      <div class="flex flex-column align-items-center justify-content-center">
        <img alt="Avatar" class="w-4rem h-4rem" src="/demo/images/avatar/circle/avatar-f-2@2x.png"/>
        <span class="mt-3 font-bold text-900 text-center white-space-nowrap">Jane Cooper</span>
      </div>
    </div>
    <div class="text-center my-6">
      <img alt="Image" class="w-full" src="/demo/images/blog/blogdetail.png"/>
    </div>
    ...
    <p class="line-height-3 text-lg mb-4">
      ...
      hitting
      “Publish,” you might spend several days or maybe even a week “writing” a blog post, but it&lsquo;s important to
      spend those vital hours planning your post and even thinking about Your Post(yes, thinking counts as working if
      you&lsquo;re a
      blogger) before you actually write it.
    </p>
    <p class="line-height-3 text-lg mb-4">There&lsquo;s an old maxim that states, “No fun for the writer, no fun for the
      reader.”No matter what industry you&lsquo;re working in, as a blogger, you should live and die by this
      statement.</p>
    <p class="line-height-3 text-lg mb-4">
      Before you do any of the following steps, be sure to pick a topic that actually interests you. Nothing - and I
      mean NOTHING- will kill a blog post more effectively than a lack of enthusiasm from the writer. You can tell when
      a writer is
    ...
    <p class="line-height-3 text-lg mb-4">
      ...
      your pain, I really do. During the course of my career, I&lsquo;ve written content for dozens of clients in some
      less-than-thrilling industries (such as financial regulatory compliance and corporate housing), but the hallmark
      of a professional blogger is the ability to write well about any topic, no matter how dry it may be. Blogging is a
      lot
      easier, however, if you can muster at least a little enthusiasm for the topic at hand.
    </p>
    <div class="text-2xl text-900 mb-4 font-semibold">Commodo ultrices orci tempus et fermentum, pellentesque
      ultricies.
    </div>
    <ul class="text-xl p-0 my-0 ml-5">
      ...
      <li class="mb-3 line-height-3">Enim in porta facilisi a vulputate fermentum, morbi. Consequat, id praesent
        tristique euismod pellentesque.
      </li>
      <li class="mb-3 line-height-3">Implements This is an external link</li>
      <li class="line-height-3">Scelerisque ultricies tincidunt lectus faucibus non morbi sed nibh varius. Quam a,
        habitasse egestaseleifend.
      </li>
    </ul>
    <div class="flex flex-column sm:flex-row my-8 w-full gap-3">
      <Button icon="pi pi-twitter" label="Twitter" severity="secondary"></Button>
      <Button icon="pi pi-facebook" label="Facebook" severity="secondary"></Button>
      <Button class="sm:ml-auto" icon="pi pi-pencil" label="Edit Post" @click="navigateToEdit"></Button>
    </div>
    ...
    <ul class="list-none p-0 m-0">
      <li v-for="(comment, i) in comments" :key="{ i }" class="flex p-3 mb-3 border-1 surface-border border-round">
        <img :alt="'Image' + i" :src="comment.image" class="w-3rem h-3rem mr-3 flex-shrink-0"/>
        <div>
