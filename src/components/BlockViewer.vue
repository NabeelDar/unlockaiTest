  ...
  <div class="block-section">
    <div class="block-header">
      ...
      <div class="block-actions">
        <a :class="{ 'block-action-active': blockView === BlockView.PREVIEW }" tabindex="0"
           @click="activateView($event, BlockView.PREVIEW)"><span>Preview</span></a>
        <a :class="{ 'block-action-active': blockView === BlockView.CODE }" :tabindex="'0'"
           @click="activateView($event, BlockView.CODE)">
          <span>Code</span>
        </a>
        <a v-tooltip.focus.bottom="{ value: 'Copied to clipboard' }" :tabindex="0" class="block-action-copy"
           @click="copyCode($event)"><i class="pi pi-copy"></i></a>
      </div>
    </div>
