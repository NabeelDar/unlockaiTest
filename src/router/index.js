        ...
        children: [
            {
                path: '/verifying',
                name: 'verifying',
                component: () => import("@/views/apps/Loader.vue")
            },
            {
                path: '/',
                name: 'dashboard',
            ...
            {
                path: '/scheduler',
                component: () => import('@/views/apps/scheduler/ContentUpload.vue'),
                meta: {requiresAuth: true}

            },
            {
                path: '/generate-ai-caption-hashtags/:id',
                component: () => import('@/views/apps/scheduler/GenerateCaption.vue'),
                meta: {requiresAuth: true}
            },
            {
                path: '/voiceover',
                component: () => import('@/views/apps/voiceover/VoiceoverTable.vue'),
                meta: {requiresAuth: true}
            },
            {
                path: '/image-generator',
                component: () => import('@/views/apps/image-gen/ImageGenerator.vue'),
                meta: {requiresAuth: true}
            },
            {
                path: '/speech-to-text',
                component: () => import('@/views/apps/speech-to-text/SpeechToText.vue'),
                meta: {requiresAuth: true}
            },
            {
                path: '/industry-experts',
                component: () => import('@/views/apps/industry-experts/IndustryExperts.vue'),
                meta: {requiresAuth: true}
            },
            {
                path: '/ai-chat',
                component: () => import('@/views/apps/chat/AiChats.vue'),
                meta: {requiresAuth: true}
            },
            {
                path: '/my-documents',
                component: () => import('@/views/apps/user/MyDocuments.vue'),
                meta: {requiresAuth: true}
            },
            {
                path: '/plans',
                component: () => import('@/views/apps/user/Plans.vue'),
            },
            {
                path: '/reporting',
                component: () => import('@/views/apps/user/ReportsAnalytics.vue'),
                meta: {requiresAuth: true}
            },
            {
                path: '/ai-auto-photo-editor',
                component: () => import('@/views/apps/photo-edit/PhotoEditor.vue'),
                meta: {requiresAuth: true}
            },
            {
                path: '/brands',
            ...
            {
                path: '/settings',
                component: () => import('@/views/apps/user/Settings.vue'),
                meta: {requiresAuth: true}
            },
            /*
            {
...
const LOGIN_URL = 'https://www.unlockai.xyz/signin';
