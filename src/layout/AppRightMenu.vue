...
<template>
  <Sidebar v-model:visible="layoutState.rightMenuActive.value" class="layout-profile-sidebar w-full sm:w-25rem"
           position="right">
    <div class="p-0 py-3weather-section">
      <div class="flex align-items-center justify-content-between mb-3">
        <h6 class="m-0">Today</h6>
      </div>
      <div class="weather flex align-items-center py-3 px-4 bg-center bg-no-repeat bg-cover border-round-lg"
           style="box-shadow: 0px 10px 40 rgba(#293241, 6%); background-image: url('/demo/images/rightpanel/asset-weather.png')">
        <img alt="freya-layout" src="/demo/images/rightpanel/icon-sun.svg" style="height: 60px"/>
        <div class="ml-3">
    ...
    <div class="rightpanel-section mt-4">
      <div class="flex align-items-center justify-content-between mb-3">
        ...
        <Button icon="pi pi-plus" rounded severity="secondary" text type="button"></Button>
      </div>
      ...
      <div class="favorite-items flex align-items-center flex-wrap" style="margin: -7px">
        <a
            ...
            style="
                    ...
                    "
        >
          <img alt="freya-layout" src="/demo/images/rightpanel/github.svg"/>
        </a>
        <a
            class="favorite-item hover:surface-50 surface-0 flex align-items-center justify-content-center border-round-xl m-2 transition-all transition-duration-200"
            href="#"
            style="
                    ...
                    "
        >
          <img alt="freya-layout" src="/demo/images/rightpanel/slack.svg"/>
        </a>
        <a
            class="favorite-item hover:surface-50 surface-0 flex align-items-center justify-content-center border-round-xl m-2 transition-all transition-duration-200"
            href="#"
            style="
                    ...
                    "
        >
          <img alt="freya-layout" src="/demo/images/rightpanel/aws.svg"/>
        </a>
        <a
            class="favorite-item hover:surface-50 surface-0 flex align-items-center justify-content-center border-round-xl m-2 transition-all transition-duration-200"
            href="#"
            style="
                    ...
                    "
        >
          <img alt="freya-layout" src="/demo/images/rightpanel/jenkins.svg"/>
        </a>
        <a
            class="favorite-item hover:surface-50 surface-0 flex align-items-center justify-content-center border-round-xl m-2 transition-all transition-duration-200"
            href="#"
            style="
                    ...
                    "
        >
          <img alt="freya-layout" src="/demo/images/rightpanel/jira.svg"/>
        </a>
        <a
